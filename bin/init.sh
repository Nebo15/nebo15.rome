...
rome_branch="mbank.api.serega" #branch name github.com/Nebo15/nebo15.rome/ with puppet configuration
server_name="sms.forza.md" #project name for automatic generate public key
environment="prod" #default environment
projects=("mbank.api.serega") #list of projects for cloning
